...
class Game {
    ...
    startNewBlockGroup() {
        this.activeBlockGroup = new BlockGroup(new Block(new Point(3, 0), this.getRandomColor()), new Block(new Point(4, 0), this.getRandomColor()), this.idCounter++);
            ...
            for (let y = 0; y < this.blocks[x].length; y++) {
                if (this.blocks[x][y] !== null) {
                    ...
                    for (let lx = x + 1; lx <= maxX; lx++) {
                        if (this.blocks[lx][y] !== null && this.blocks[lx][y].color === currentColor) {
                    ...
                    for (let ly = y + 1; ly <= maxY; ly++) {
                        if (this.blocks[x][ly] !== null && this.blocks[x][ly].color === currentColor) {
                            vertical.push([x, ly]);
                        } else {
                            break;
                        }
